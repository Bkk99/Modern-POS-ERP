...
const Database: React.FC = () => {
    const { db, dbFileName, loadDbFromFile, exportDb, disconnectDb, createNewDb } = useInventory();
                 ...
                 <div className="p-6 bg-white rounded-xl shadow-md">
                    <h3 className="text-lg font-semibold text-slate-800 mb-4 flex items-center"><HelpCircle className="mr-2 text-indigo-500"/>วิธีการทำงาน</h3>
                     <div className="space-y-3 text-sm text-slate-600">
                        <p>
                           คุณสามารถ <strong className="text-indigo-600">สร้างฐานข้อมูลใหม่</strong> เพื่อเริ่มต้น หรือ <strong className="text-indigo-600">เชื่อมต่อกับไฟล์ SQLite ที่มีอยู่</strong> เพื่อให้ข้อมูลของคุณพกพาได้และปลอดภัย
                        </p>
                        <p>
